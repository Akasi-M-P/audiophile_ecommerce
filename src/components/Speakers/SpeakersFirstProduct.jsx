...
import ProductMobile from "../../images/product-zx9-speaker/mobile/image-product.jpg";
import ProductTablet from "../../images/product-zx9-speaker/tablet/image-product.jpg";
import ProductDesktop from "../../images/product-zx9-speaker/desktop/image-product.jpg";
import ManImageMobile from "../../images/product-zx9-speaker/mobile/image-gallery-1.jpg";
import SecondImageMobile from "../../images/product-zx9-speaker/mobile/image-gallery-2.jpg";
import LastImageMobile from "../../images/product-zx9-speaker/mobile/image-gallery-3.jpg";
import ManImageTablet from "../../images/product-zx9-speaker/tablet/image-gallery-1.jpg";
import SecondImageTablet from "../../images/product-zx9-speaker/tablet/image-gallery-2.jpg";
import LastImageTablet from "../../images/product-zx9-speaker/desktop/image-gallery-3.jpg";
...
import ZX7SpeakerMobile from "../../images/shared/mobile/image-zx7-speaker.jpg";
...
import ZX7SpeakerTablet from "../../images/shared/tablet/image-zx7-speaker.jpg";
...
import ZX7SpeakerDesktop from "../../images/shared/desktop/image-zx7-speaker.jpg";
          ...
          <div className="flex flex-col gap-8 mt-6">
            ...
            <div className="flex flex-row gap-4">
              <div className="flex flex-row justify-between p-[15px] w-[120px] bg-silver text-black text-[13px] font-bold tracking-[1px]">
                ...
                <span
                  className="cursor-pointer opacity-50"
                  onClick={() => setZX9Amount(ZX9Amount + 1)}
                >
                  +
                </span>
              </div>
...
export default SpeakersFirstProduct;
